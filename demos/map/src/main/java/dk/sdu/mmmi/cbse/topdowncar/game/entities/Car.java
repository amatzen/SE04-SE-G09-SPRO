package dk.sdu.mmmi.cbse.topdowncar.game.entities;
...
import dk.sdu.mmmi.cbse.topdowncar.game.BodyHolder;
import dk.sdu.mmmi.cbse.topdowncar.game.tools.MapLoader;

import static dk.sdu.mmmi.cbse.topdowncar.game.Constants.PPM;
...
public class Car extends BodyHolder {
    ...
    private static final Vector2 WHEEL_SIZE = new Vector2(8,16).scl(1/21f);
    ...
    private static final float WHEEL_OFFSET_X = .71f;
    private static final float WHEEL_OFFSET_Y = 1.07f;
